...
class HistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> purchases = [
      {'item': 'Pyjama', 'price': '30 TND', 'date': '28/11/2024', 'image': 'assets/images/4.png'},
      {'item': 'Manteau', 'price': '50 TND', 'date': '25/11/2024', 'image': 'assets/images/5.png'},
    ];

    final List<Map<String, String>> sales = [
      {'item': 'Armoire', 'price': '200 TND', 'date': '22/11/2024', 'image': 'assets/images/7.png'},
    ];
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/images/Hist.png'), // Image ajoutée
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
